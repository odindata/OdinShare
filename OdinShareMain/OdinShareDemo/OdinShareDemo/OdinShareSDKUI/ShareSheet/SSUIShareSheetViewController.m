...
- (void)_configUI
{
    ...
    Class cellClass = SSUICollectionViewCell.class;//self.configuration.style == SSUIActionSheetStyleSystem ? SSUICollectionViewCell.class:SSUICollectionViewSimpleCell.class;
