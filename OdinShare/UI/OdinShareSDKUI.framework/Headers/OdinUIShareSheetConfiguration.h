//
//  OdinUIShareSheetConfiguration.h
//  OdinShareSDKUI
//
 ...
 *  ShareSDK UI风格
 */
typedef NS_ENUM(NSInteger, OdinUIActionSheetStyle)  {
    OdinUIActionSheetStyleSystem     = 0,    // 系统类型，默认
    OdinUIActionSheetStyleSimple     = 1,    // 简洁类型
};

typedef NS_ENUM(NSUInteger, OdinUIItemAlignment) {
    OdinUIItemAlignmentLeft,
    OdinUIItemAlignmentCenter,
    OdinUIItemAlignmentRight,
};

NS_ASSUME_NONNULL_BEGIN

@interface OdinUIShareSheetConfiguration : NSObject

/**
 *  设置ShareSDK UI风格
 */
@property (assign, nonatomic) OdinUIActionSheetStyle style;
 ...
 *  对齐方式 注：简约版菜单无居中对齐
 */
@property (assign, nonatomic) OdinUIItemAlignment itemAlignment;
